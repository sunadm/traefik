...
| xargs -0 -r -P "${NUMBER_OF_CPUS}" -I '{}' \
  ...
  --url_ignore="/https://groups.google.com/a/traefik.io/forum/#!forum/security/,/localhost:/,/127.0.0.1:/,/fonts.gstatic.com/,/.minikube/,/github.com\/containous\/traefik\/*edit*/,/github.com\/containous\/traefik\/$/,/docs.traefik.io/,/github\.com\/golang\/oauth2\/blob\/36a7019397c4c86cf59eeab3bc0d188bac444277\/.+/,/www.akamai.com/,/github.com\/sunadm\/traefik\/*edit*/,/github.com\/sunadm\/traefik\/$/,/traefik-docs.livedig.com/" \
  '{}' 1>/dev/null
